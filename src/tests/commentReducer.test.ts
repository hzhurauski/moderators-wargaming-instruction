import commentReducer, { actions, InitialStateType, TextareaRequestThunk } from "./../redux/commentReducer"
...
const response: ResponseType<Array<CommentType>> = {
    comments: [
        { name: 'Пользователь', message: 'Когда будут добавлены новые сети?', isAdmin: false, id: 1, date: '18.07.2021' },
        { name: 'Ответ администратора сайта:', message: 'Совсем скоро, работаем над этим!', isAdmin: true, id: 2, date: '18.07.2021' }
    ],
